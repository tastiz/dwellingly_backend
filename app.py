...
# #replace with .env keep it secret, keep it safe
api = Api(app)

app.config['SQLALCHEMY_DATABASE_URI'] =\
    'postgresql://postgres:password@localhost/users'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False

db = SQLAlchemy(app)

jwt = JWT(app, authenticate, identity)  # /auth token
#jwt will need to be implemented tested
# works with user class. will need to be tied to DB and put into
